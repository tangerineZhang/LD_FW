...
namespace LDFW.DAL
{
	...
	public partial class FW_LawInfo
	{
		...
		public bool Add(LDFW.Model.FW_LawInfo model)
		{
			...
			parameters[1].Value = model.LawName;
			parameters[2].Value = model.GradeID;
			parameters[3].Value = model.Grade;
			parameters[4].Value = model.LawsuitTypeID;
			parameters[5].Value = model.LawsuitType;
			parameters[6].Value = model.LawTypeID;
			parameters[7].Value = model.LawType;
			parameters[8].Value = model.DepartmentID;
			parameters[9].Value = model.Department;
			parameters[10].Value = model.PlaintiffID;
			parameters[11].Value = model.Plaintiff;
			parameters[12].Value = model.DefendantID;
			parameters[13].Value = model.Defendant;
			parameters[14].Value = model.TheThirdID;
			parameters[15].Value = model.TheThird;
			parameters[16].Value = model.CourtID;
			parameters[17].Value = model.Court;
			parameters[18].Value = model.CaseNo;
			parameters[19].Value = model.LawFirmID;
			parameters[20].Value = model.LawFirm;
			parameters[21].Value = model.FilingDate;
			parameters[22].Value = model.ClosingDate;
			parameters[23].Value = model.LawStatusID;
			parameters[24].Value = model.LawStatus;
			parameters[25].Value = model.Describe;
			parameters[26].Value = model.Claims;
			parameters[27].Value = model.AmountInvolved;
			parameters[28].Value = model.AmountueDU;
			parameters[29].Value = model.Compensation;
			parameters[30].Value = model.SStopLoss;
			parameters[31].Value = model.AStopLoss;
			parameters[32].Value = model.StopLossRate;
			parameters[33].Value = model.RiskExposure;
			parameters[34].Value = model.IsAssessID;
			parameters[35].Value = model.IsAssess;
			parameters[36].Value = model.Solutions;
			parameters[37].Value = model.PersonLiableID;
			parameters[38].Value = model.PersonLiable;
			parameters[39].Value = model.PersonFollowUpID;
			parameters[40].Value = model.PersonFollowUp;
			parameters[41].Value = model.FollowUpRecord;
			parameters[42].Value = model.ModifyDate;
			parameters[43].Value = model.SortID;
			parameters[44].Value = model.ISValid;
			parameters[45].Value = model.CreatorID;
			parameters[46].Value = model.Creator;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(LDFW.Model.FW_LawInfo model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		public bool Delete()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from FW_LawInfo ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public LDFW.Model.FW_LawInfo GetModel()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,LawName,GradeID,Grade,LawsuitTypeID,LawsuitType,LawTypeID,LawType,DepartmentID,Department,PlaintiffID,Plaintiff,DefendantID,Defendant,TheThirdID,TheThird,CourtID,Court,CaseNo,LawFirmID,LawFirm,FilingDate,ClosingDate,LawStatusID,LawStatus,Describe,Claims,AmountInvolved,AmountueDU,Compensation,SStopLoss,AStopLoss,StopLossRate,RiskExposure,IsAssessID,IsAssess,Solutions,PersonLiableID,PersonLiable,PersonFollowUpID,PersonFollowUp,FollowUpRecord,ModifyDate,SortID,ISValid,CreatorID,Creator,CreateDate from FW_LawInfo ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};

			LDFW.Model.FW_LawInfo model=new LDFW.Model.FW_LawInfo();
		...
		/// 得到一个对象实体
		/// </summary>
		public LDFW.Model.FW_LawInfo DataRowToModel(DataRow row)
		{
			LDFW.Model.FW_LawInfo model=new LDFW.Model.FW_LawInfo();
			if (row != null)
			{
				...
				{
					model.StopLossRate= decimal.Parse(row["StopLossRate"].ToString());
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,LawName,GradeID,Grade,LawsuitTypeID,LawsuitType,LawTypeID,LawType,DepartmentID,Department,PlaintiffID,Plaintiff,DefendantID,Defendant,TheThirdID,TheThird,CourtID,Court,CaseNo,LawFirmID,LawFirm,FilingDate,ClosingDate,LawStatusID,LawStatus,Describe,Claims,AmountInvolved,AmountueDU,Compensation,SStopLoss,AStopLoss,StopLossRate,RiskExposure,IsAssessID,IsAssess,Solutions,PersonLiableID,PersonLiable,PersonFollowUpID,PersonFollowUp,FollowUpRecord,ModifyDate,SortID,ISValid,CreatorID,Creator,CreateDate ");
			strSql.Append(" FROM FW_LawInfo ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM FW_LawInfo ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from FW_LawInfo T ");
